...
// Fetch quota
$kuota = (int) $koneksi->query("SELECT jumlah FROM kuota WHERE jalur = 'Afirmasi'")->fetch_assoc()['jumlah'];

// Fetch students
$sql = "SELECT no_pendaftaran, nama_lengkap, sekolah_asal, jarak_rumah, is_disabilitas, status_pendaftaran FROM calon_siswa WHERE jalur_pendaftaran = 'Afirmasi' AND status_pendaftaran = 'Terverifikasi'";
if ($is_active) {
    header("Location: hasil_seleksi.php");
    exit();
}
$sql .= " ORDER BY is_disabilitas DESC, jarak_rumah ASC, tanggal_daftar ASC";
...
<head>
    ...
    <title>Jurnal Jalur Afirmasi - PPDB Online</title>
...
<body>
    ...
    <div class="container my-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h2 class="mb-0 text-center">Jurnal Jalur Afirmasi</h2>
            <div style="width: 80px;"></div>
        </div>
        <p class="text-center lead">Kuota Jalur: <strong><?php echo $kuota; ?> siswa</strong>. Peringkat diurutkan berdasarkan prioritas disabilitas, kemudian jarak terdekat.</p>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($siswa['jarak_rumah']); ?> m</td>
                                <td>
                                    <?php if ($siswa['is_disabilitas'] == 1): ?>
                                        <span class="badge bg-primary">Disabilitas</span>
                                    <?php else: ?>
                                        <span class="badge bg-info text-dark">Jarak</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php 
