...
// Fetch quota
$kuota = (int) $koneksi->query("SELECT jumlah FROM kuota WHERE jalur = 'Akademik'")->fetch_assoc()['jumlah'];

// Fetch students
$sql = "SELECT no_pendaftaran, nama_lengkap, sekolah_asal, skor_akhir, status_pendaftaran FROM calon_siswa WHERE jalur_pendaftaran = 'Akademik' AND status_pendaftaran = 'Terverifikasi'";
if ($is_active) {
    // If announcement is active, this page shouldn't be accessed directly anyway, but as a fallback...
...
<head>
    ...
    <title>Jurnal Prestasi Akademik - PPDB Online</title>
...
<body>
    ...
    <div class="container my-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h2 class="mb-0 text-center">Jurnal Jalur Prestasi Akademik</h2>
